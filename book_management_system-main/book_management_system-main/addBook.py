...
# create label and add resize image
    ...
    bookInfo4 = StringVar()
    bookInfo4.set("select")  # Default value
    status_options = ["Available", "Issued"]
    status_dropdown = OptionMenu(LabelFrame, bookInfo4, *status_options)
    status_dropdown.place(relx=0.3, rely=0.65, relwidth=0.2, relheight=0.1)
    # #entry for status
